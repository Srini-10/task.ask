...
const getItems = (
  ...
  const DataInterpretationTestTestTextList = [
    "Data Analysis",
  ...
  const filteredDataInterpretationTestTestTextList =
    DataInterpretationTestTestTextList.filter((line) =>
      ...
      label: (
        <div style={{ display: "flex", justifyContent: "space-between" }}>
          ...
          <span style={{ color: "lightgray" }}>
            {filteredDataInterpretationTestTestTextList.length}
          </span>
        </div>
      ),
      children: (
        <div>
          ...
          <ul style={{ marginLeft: "20px" }}>
            {filteredDataInterpretationTestTestTextList.map((item, index) => (
              <li
                key={index}
                style={{
                  display: "flex",
...
function DataInterpretationTestTest() {
...
export default DataInterpretationTestTest;
