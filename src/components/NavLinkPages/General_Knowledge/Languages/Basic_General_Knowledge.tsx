...
const getItems = (
  ...
  const BasicGeneralKnowledgeTextList = [
    "World Geography",
    "History",
    "Science",
    "Politics",
  ...
  const filteredBasicGeneralKnowledgeTextList =
    BasicGeneralKnowledgeTextList.filter((line) =>
  ...
  return [
    {
      ...
      label: (
        <div style={{ display: "flex", justifyContent: "space-between" }}>
          <span>Basic General Knowledge</span>
          <span style={{ color: "lightgray" }}>
            {filteredBasicGeneralKnowledgeTextList.length}
          </span>
        </div>
      ),
      children: (
        <div>
          ...
          <ul style={{ marginLeft: "20px" }}>
            {filteredBasicGeneralKnowledgeTextList.map((item, index) => (
              <li
                key={index}
                style={{
                  display: "flex",
              ...
              >
                ...
                />{" "}
                <Link
                  to={`/Basic_GK/${encodeURIComponent(
...
function BasicGeneralKnowledge() {
