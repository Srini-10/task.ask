...
const getItems = (
  ...
  const filteredProgrammingTextList = programmingTextList.filter((line) =>
            ...
            {filteredProgrammingTextList.map((item, index) => (
              ...
              >
                ...
                <Link
                  to={`/${
                    item === "C Programming"
                      ? "Programming_GK/c-programming"
                      : item === "C++ Programming"
                      ? "Programming_GK/c++_programming"
                      : `Programming_GK/${encodeURIComponent(
